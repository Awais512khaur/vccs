    ...
    <section class="content">
		  ...
		  <div class="box box-primary ">
				   ...
				   <div class="box-header">
					  <h3 class="box-title">Archive Customer Information</h3>
					</div>
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                    ...
                    <tbody>
					  ...
					  <?php
						foreach($manager->outlite->deletedcustomer as $customer){
					  ?>
					  ...
					  <tr>
						...
						<td>
							<a type="button" href="./AllowCustomer.php?id=<?php echo htmlspecialchars($customer->id); ?>" class="btn btn-primary  btn-sm">Allow</a> 
						</td>
